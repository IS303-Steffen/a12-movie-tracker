max_score = 12  # This value is pulled by yml_generator.py to assign a score to this test.
...
def test_04_year_released_validation(current_test_name, input_test_cases):
    try:
        ...
        input_test_case = input_test_cases[1]
        ...
        try:
            ...
            formatted = format_error_message(
                custom_message=(f"Your {expected_database_name} database didn't contain the expected values.\n\n"
                                ...
                                f"This test is specifically checking if you are validating the year_released field correctly. If your values have "
                                f"multiple values per field, that means you are letting some movies be created even though their year isn't valid. "
                                f"Double check the logic of your overridden .create() method."
                                f"\n\n"),
                current_test_name=current_test_name,
                input_test_case=input_test_case,
                display_inputs=True,
